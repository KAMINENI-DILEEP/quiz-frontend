...
// ==========================================================================
// 4. PASSWORD VISIBILITY TOGGLE UTILITY
// ==========================================================================
...
function togglePasswordDisplay(fieldId) {
    ...
    // Find the toggle button and its child icon element
    ...
    // Refresh Lucide icon rendering engine safely
    if (window.lucide) {
        lucide.createIcons();
    }
}